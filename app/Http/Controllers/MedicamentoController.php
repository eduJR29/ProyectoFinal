...
class MedicamentoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('medicamento.medicamentoIndex', compact('medicamentos'));
    }
    ...
    public function create()
    {
        ...
        return view('medicamento.medicamentoCreate', compact('pacientes'));
    }
    ...
    {
        $request->validate([
            'nombre_medicamento' => 'required|min:3|max:255',
            'presentacion' => 'required|max:255',
            'cantidad' => 'required|min:0|max:99',
        ]);
    ...
    {
        return view('medicamento.medicamentoShow', compact('medicamento'));
    }
